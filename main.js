...
function drawAreaChart(data, width, height, type, colors, content) {
    ...
    svg.innerHTML = `
    <defs>
        <linearGradient id="gradiente-${newId}" x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    <defs>
        <linearGradient id="gradiente2-${newId}" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    area.setAttribute("fill", `url(#gradiente-${newId})`);
    ...
    curve.setAttribute("stroke", `url(#gradiente2-${newId})`);
